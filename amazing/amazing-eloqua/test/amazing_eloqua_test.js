...
describe('amazing_eloqua_login.js', function() 
{
  describe('init', function() 
  {
    ...
    it('login with wrong credentials doesnt work', function() 
    {
      var eloqua = amazingEloqua.login();
      should.exist(eloqua);
      eloqua.should.be.an.Object;
    });
  });
  ...
  {
    it('login and get ID with wrong credentials', function(done) 
    {
      var eloqua = amazingEloqua.login(companyName, username, '123456789');

      eloqua.getId(function(err, res)
      {
        
        res.should.eql('Not authenticated.');
        (err === null).should.be.true;
        done();
      });
    });

    it('login and get ID', function(done) 
    {
      var eloqua = amazingEloqua.login(companyName, username, '5urcluVIFb8pYkg0');
      eloqua.getId(function(err, res)
      {
        res.should.not.equal('Not authenticated.');
        res.site.should.eql(
            { 
              id: 1926145509,
              name: companyName 
  ...
  describe('amazing_eloqua_login.js', function() 
  {
    ...
    before(function() 
    {
      eloqua = amazingEloqua.login(companyName, username, '5urcluVIFb8pYkg0', 'https://www02.secure.eloqua.com');  // Important choose the right base url
    })

    it('searchContacts', function(done) 
    {
      eloqua.searchContacts('', '1', '10', 'complete', function(err, res)
      {
        res.page.should.eql(1);
        res.pageSize.should.eql(10);
        (err === null).should.be.true;
        //console.log(res);
        done();
      });
    ...
    it('searchContactField', function(done) 
    {
      eloqua.searchContactField('*', '1', '100', 'complete', function(err, res)
      {
  ...
  describe('getemails', function() 
  {
    ...
    it('getEmailByID', function(done) 
    {
      var _email_id = '59';
      eloqua.getEmailById(_email_id, 'complete', function(err, res)
      {
        //console.log(err);
        //console.log(res);
        res.id.should.eql(_email_id);
        res.type.should.eql('Email');
        (res.htmlContent !== null && res.htmlContent.html !== null).should.be.true;
        (err === null).should.be.true;
        done();
      });
    }); 
  ...
  describe('getCampaigns', function() 
  {
    ...
    it('searchforCampaigns', function(done) 
    {
      ...
      eloqua.searchCampaigns('*', '1', '100', 'complete', function(err, res)
      {
        console.log(err);
        console.log(res);
  ...
  describe.skip('sendInlineEmaial', function() 
  {
    var eloqua;
    before(function() 
    {
    ...
    it('sendInlineEmaial', function(done) 
    {
      var contacts = [  
        {  
  ...
  describe('getActivities', function() 
  {
    ...
    it('getActivities', function(done) 
    {
   
      eloqua.getActivites('EmailOpen', '2015-01-01', '2015-11-01', function(err, res)
      {
        console.log('getActivites callback');
        console.log(err);
        console.log(res);
