    ...
    return {
        ...
        createCompany: function(req, res, next) 
        {
            ...
            company.save(function(err) 
            {
                ...
                user.provider = 'local';
                user.companies = [{id: company._id, name:company.name, roles: ['Company_Admin', company.name]}];
                ...
                user.save(function(errUser) 
                {
                    if (errUser) 
                    {
                        switch (errUser.code) 
                        {
                            ...
                            if (errUser.errors) 
                            {
                                for (var x in errUser.errors) 
                                {
                                    modelErrors.push(
                                    {
                                        param: x,
                                        msg: errUser.errors[x].message,
                                        value: errUser.errors[x].value
                                    });
                                }
