...
module.exports = function(Admin, app, auth, database) {
    ...
    app.get('/api/admin/companies', auth.requiresAdmin, companies.all);
    app.post('/api/admin/companies', auth.requiresAdmin, companies.create);
    app.put('/api/admin/companies/:userId', auth.requiresAdmin, companies.update);
    app.delete('/api/admin/companies/:userId', auth.requiresAdmin, companies.destroy);    

    app.get('/api/admin/invites', auth.requiresAdmin, companies.allInvites);
    app.post('/api/admin/invites', auth.requiresAdmin, companies.createInvite);
    app.put('/api/admin/invites/:inviteId', auth.requiresAdmin, companies.updateInvite);
    app.delete('/api/admin/invites/:inviteId', auth.requiresAdmin, companies.destroyInvite);
