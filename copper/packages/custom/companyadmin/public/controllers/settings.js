'use strict';
angular.module('mean.companyadmin').controller('CompanySettingsController', ['$scope', 'Global', 'CompanySettings',
    function($scope, Global, CompanySettings) {
        ...
        $scope.init = function() {
            CompanySettings.get(function(data) {
                if (data.success) {
        ...
        $scope.update = function(settings) {
            ...
            CompanySettings.update(settings, function(data) {});
        };
